    ...
    <div className="w-screen sm:w-[calc(100vw-240px)] lg:max-w-2xl no-scrollbar overflow-x-auto px-4">
      <div className="flex gap-4 pb-5">
        ...
        <div
          ...
          className="rounded-lg shadow-sm min-w-30 max-w-30 aspect-3/4 cursor-pointer hover:shadow-lg transition-all duration-200 border-2 border-dashed border-indigo-300 bg-linear-to-b from-indigo-50 to-white"
        >
        ...
        {stories.map((story, index) => (
          ...
          >
            ...
            {story.media_type !== "text" && (
              <div className="absolute inset-0 z-1 rounded">
