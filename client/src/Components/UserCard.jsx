  ...
  return (
    ...
    >
      ...
      <div className="flex mt-4 gap-2">
       ...
       <button onClick={handleConnectionRequest} className="flex justify-center items-center w-16 border text-slate-500 group rounded-md cursor-pointer active:scale-95 transition">
