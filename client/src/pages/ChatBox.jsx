...
function ChatBox() {
  ...
  //naye message aane par chat apne aap scroll ho jayegii
  useEffect(() => {
      ...
      <div className="flex flex-col h-screen">
        ...
        <div className="px-4">
          <div className="flex items-center gap-3 pl-5 p-1.5 bg-white w-full max-w-xl mx-auto border border-gray-200 shadow rounded-full mb-5">
            ...
            <button className="bg-linear-to-br from-indigo-500 to-purple-600 hover:from-indigo-700 hover:to-purple-800 active:scale-95 cursor-pointer text-white p-2 rounded-full">
