...
export const updateUserData=async (req,res)=>{
  try {
    ...
    if(tempUser.username!==username){
      ...
      if(user){
        //this is username is already taken so we not change
    ...
    //agar profile hogi to pehle uska buffer fir use upload kar rhe.. fir url generate kar rhe ..updated data me add kar de rhe
    if(profile){
